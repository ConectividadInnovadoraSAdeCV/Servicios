...
namespace LoadWeonLogFiles
{
    ...
    class AccessConeccion
    {
        ...
        {
            /*
            ConeccionString = "Data Source = "+Server()+";initial catalog=ATsolutions; user id= RPCandle; password = Rosario13";
            /*/
        ...
        public string Server()
        {
            ...
            try
            {
                PingReply reply = pingSender.Send("AT01", timeout, buffer, options);
            }
            catch(Exception)
            {
                return "atsolutions.dynalias.com";
            }
            return "AT01";
        }
